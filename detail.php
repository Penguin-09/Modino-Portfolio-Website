...
<head>
	...
	<meta name="description" content="<?= htmlspecialchars(mb_substr(strip_tags($projectData['description']), 0, 155)) ?>">
    <link
                ...
                <div class="d-flex">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto d-flex flex-row flex-wrap">
                            ...
                            <?php
                            foreach ($allProjectData as $category) {
                                echo '<li class="nav-item me-4 mb-1"><a href="index.php#' . $category['category'] . '" class="btn btn-outline-light fs-6">' . str_replace('_', ' ', $category['category']) . '</a></li>';
                            }
                            ?>
